...
class CI_DB_active_record extends CI_DB_driver {
	...
	public function db_read_link($is_read = 1) {
		$this->ar_db_link = $is_read ? $this->conn_read : $this->conn_write;
		return $this;
	}
	...
	public function get($table = '', $limit = null, $offset = null)
	{
		...
		$result = $this->query($sql, $this->ar_db_link);
		$this->_reset_select();
		return $result;
	}
	...
	public function count_all_results($table = '')
	{
		...
		$query = $this->query($sql, $this->ar_db_link);
		$this->_reset_select();
